...
Page({
  ...
  data: {
    ...
    examArrangeList: [],
    activeNames: [],
    showTip: false // 是否显示无数据提示
  },
  // 更新面板选中数组
  onChange(event) {
    // console.log(event.detail, this.data.activeNames)
    this.setData({
  ...
  toExam(e){
    ...
    Dialog.alert({
      ...
      wx.navigateTo({
        url: `/pages/recognition/index?url=VerifyFace&ultimateUrl=${'/pages/examination-module/examination-paper/index'}`
      })
    })
    // wx.navigateTo({
    //   // url: ``

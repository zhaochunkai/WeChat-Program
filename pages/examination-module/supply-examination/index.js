...
Page({
  ...
  // 获取考试安排列表
  _getResitExaminationArrangeList() {
    ...
    weChatExamination.getResitExaminationArrangeList(data).then(res => {
  ...
  toExamResult(e) {
    ...
    let data = {
      // id: arrange.id, // 补考考试安排id
      examinationArrangeId: arrange.id, // 考试安排id
      classId: arrange.classId,
      examinationPaperId: paper.constructionExaminationPaperId, // 试卷id
      courseId: paper.courseId, // 课程id
      courseName: paper.courseName, // 课程名称
      examinationType: 'Official', // 考试类型
      flagSupplementaryExam: false, // 是否补考
    }
    wx.navigateTo({
      url: `/pages/examination-module/examination-record-list/examination-paper-result/index?parameter=${JSON.stringify(data)}`
    })    
  },
  // 开始考试
  toExam(e) {
    ...
    let data = {
      id: arrange.id, // 补考考试安排id
      examinationArrangeId: arrange.examinationArrangeId, // 考试安排id
      trainingProgramId: arrange.trainingProgramId, // 项目id
      classId: arrange.classId,
      examinationPaperId: paper.constructionExaminationPaperId,
      examinationType: 'Official', // 考试类型
      methodOfExamination: arrange.methodOfExamination, // 考试方式
      courseId: paper.courseId,
      flagSupplementaryExam: true // 补考
    }    
  ...
  onShow: function () {
    ...
    // 1.获取考试安排
    this._getResitExaminationArrangeList()
  },
